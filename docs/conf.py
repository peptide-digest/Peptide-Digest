...
htmlhelp_basename = 'peptidedigestdoc'
...
latex_documents = [
    (master_doc, 'peptidedigest.tex', 'PeptideDigest Documentation',
     'peptidedigest', 'manual'),
]
...
man_pages = [
    (master_doc, 'peptidedigest', 'PeptideDigest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'peptidedigest', 'PeptideDigest Documentation',
     author, 'peptidedigest', 'LLM for summarization of scientific articles related to computational peptides.',
     'Miscellaneous'),
]
